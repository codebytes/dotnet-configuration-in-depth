...
Slides, demos, and resources for an in-depth look at .NET configuration, configuration providers, binding, and the options pattern.

## Slides

[View HTML slides](https://chris-ayers.com/dotnet-configuration-in-depth/) | [Download PDF](https://chris-ayers.com/dotnet-configuration-in-depth/Slides.pdf)

## Resources

- [Slide source](slides/Slides.md)
- [Demo solution](dotnet-configuration-in-depth.slnx)
